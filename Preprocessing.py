...
PREPROCESS_GPS_FILE_PATH = 'Preprocessing/Output/gps/output__with_coordinates.csv'
PREPROCESS_WEATHER_FILE_PATH = 'Preprocessing/Output/weather/weather_data.csv'
PREPROCESS_FINAL_FILE_PATH = 'Preprocessing/Output/final/monthly_aggregated_data_test.csv'
...
def prepData():
    ...
    coordinates_df.to_csv(PREPROCESS_GPS_FILE_PATH, index=False)
    print(f"Coordinates saved to {PREPROCESS_GPS_FILE_PATH}")

    -----------------------------------------------------------------------------------------------
    '''

    coordinates_df = pd.read_csv(PREPROCESS_GPS_FILE_PATH)
    # '''
    ...
    weather_data = get_weather_data(coordinates_df, START_DATE, END_DATE)

    if not weather_data.empty:
        weather_data.to_csv(PREPROCESS_WEATHER_FILE_PATH, index=False)
        print(f"Weather data saved to {PREPROCESS_WEATHER_FILE_PATH}")
        ...
        monthly_data.to_csv(PREPROCESS_FINAL_FILE_PATH, index=False)
        print(f"Monthly aggregated data saved to {PREPROCESS_FINAL_FILE_PATH}")
    else:
